...
//UPD
var basic_isInt = require('./basic_isInt.js');

//UPD
var basic_egcd = require('./basic_egcd.js');
...
//UPD
//keep as-is (used in other module)
/**
...
basic.divMod = function (a, b) {
  ...
  if (!basic_isInt.isInt(a) || !basic_isInt.isInt(b)) throw new Error("A or B are not integers.");
...
//UPD
//kept as-is (used in other module)
/**
...
basic.permutation = function (n, k) {
  ...
  var binomial = basic_egcd.binomial(n, k);
  var permutation = binomial * basic_egcd.factorial(k);
  return permutation;
